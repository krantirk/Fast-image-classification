...
python3 general_model.py --train train_dir --val val_dir --logs log_resnet --create_bottleneck --bottleneck_dir bottlenecks\
  --base_model resnet50 --bottlenecks_batch_size 128 --epochs 20 --weight_file Resnet50_top.h5\
...
python3 general_test.py --weight_file Resnet50_top.h5 --label_file essential_files/label_map.json \
